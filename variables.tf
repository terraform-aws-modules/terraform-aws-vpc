...
variable "public_route_table_routes_extra" {
  description = "Configuration block of additional routes for public subnets route tables. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/default_route_table#route"
  type        = list(map(string))
  default     = []
}
