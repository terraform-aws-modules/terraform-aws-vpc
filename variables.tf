...
variable "enable_redshift_endpoint" {
  description = "Should be true if you want to provision a Redshift endpoint to the VPC"
  type        = bool
  default     = false
}

variable "redshift_endpoint_security_group_ids" {
  description = "The ID of one or more security groups to associate with the network interface for Redshift endpoint"
  type        = list(string)
  default     = []
}

variable "redshift_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for Redshift Endpoint. Only a signle subnet within an AZ is supported. If omitted, private subnets will be used."
  type        = list(string)
  default     = []
}

variable "redshift_endpoint_private_dns_enabled" {
  description = "Whether or not to associate a private hosted zone with the specified VPC for Redshift endpoint"
  type        = bool
  default     = false
}
