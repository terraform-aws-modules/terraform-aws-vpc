...
module "vpc" {
  ...
  compute_private_subnets = ["20.10.1.0/24", "20.10.2.0/24", "20.10.3.0/24"]
  compute_public_subnets  = ["20.10.11.0/24", "20.10.12.0/24", "20.10.13.0/24"]
  ...
  lb_subnets              = ["20.10.61.0/24", "20.10.62.0/24", "20.10.63.0/24"]
