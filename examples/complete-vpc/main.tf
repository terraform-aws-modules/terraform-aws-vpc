...
module "vpc" {
  ...
  # Add custom route destined for another NAT Gateway managed elsewhere
  private_routes_extra = [{
    "nat_gateway_id"         = "nat-00000000000000000"
    "destination_cidr_block" = "20.20.20.0/24" # used interchangebly with cidr_block
  }]
