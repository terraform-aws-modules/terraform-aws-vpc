# Simple Regional VPCs

This configuration is meant to demonstrate the usage of the new `region` parameter, [available in aws provider >= 6.0.0](https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/guides/enhanced-region-support), to create a set of VPCs in multiple regions.
