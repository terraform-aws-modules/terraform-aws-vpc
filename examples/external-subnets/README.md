...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_external_subnets"></a> [external\_subnets](#module\_external\_subnets) | ../../modules/external-subnets | n/a |
| <a name="module_network_acls"></a> [network\_acls](#module\_network\_acls) | ../../modules/network-acls | n/a |
