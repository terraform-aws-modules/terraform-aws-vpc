# VPC with Empty Default Security Group

Configuration in this directory creates same set of VPC resources as example/simple, but with an empty default security group.
