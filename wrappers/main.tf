module "wrapper" {
  ...
  database_route_tables_routes                                   = try(each.value.database_route_tables_routes, var.defaults.database_route_tables_routes, [])
  ...
  elasticache_route_tables_routes                                   = try(each.value.elasticache_route_tables_routes, var.defaults.elasticache_route_tables_routes, [])
  ...
  intra_route_tables_routes                                   = try(each.value.intra_route_tables_routes, var.defaults.intra_route_tables_routes, [])
  ...
  private_route_tables_routes                                   = try(each.value.private_route_tables_routes, var.defaults.private_route_tables_routes, [])
  ...
  public_route_tables_routes                                   = try(each.value.public_route_tables_routes, var.defaults.public_route_tables_routes, [])
  ...
  redshift_route_tables_routes                                   = try(each.value.redshift_route_tables_routes, var.defaults.redshift_route_tables_routes, [])
