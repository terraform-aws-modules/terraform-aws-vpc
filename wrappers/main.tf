module "wrapper" {
  ...
  create_vpc_ipam_pool                   = try(each.value.create_vpc_ipam_pool, var.defaults.create_vpc_ipam_pool, false)
  ...
  ipam_subnets                                                = try(each.value.ipam_subnets, var.defaults.ipam_subnets, [])
  ...
  vpc_ipam_pool_allocation_default_netmask_length                = try(each.value.vpc_ipam_pool_allocation_default_netmask_length, var.defaults.vpc_ipam_pool_allocation_default_netmask_length, null)
  vpc_ipam_pool_allocation_max_netmask_length                    = try(each.value.vpc_ipam_pool_allocation_max_netmask_length, var.defaults.vpc_ipam_pool_allocation_max_netmask_length, null)
  vpc_ipam_pool_allocation_min_netmask_length                    = try(each.value.vpc_ipam_pool_allocation_min_netmask_length, var.defaults.vpc_ipam_pool_allocation_min_netmask_length, null)
  vpc_ipam_pool_auto_import                                      = try(each.value.vpc_ipam_pool_auto_import, var.defaults.vpc_ipam_pool_auto_import, true)
  vpc_ipam_pool_cidr                                             = try(each.value.vpc_ipam_pool_cidr, var.defaults.vpc_ipam_pool_cidr, null)
  vpc_ipam_pool_description                                      = try(each.value.vpc_ipam_pool_description, var.defaults.vpc_ipam_pool_description, null)
  vpc_ipam_pool_locale                                           = try(each.value.vpc_ipam_pool_locale, var.defaults.vpc_ipam_pool_locale, null)
  vpc_ipam_pool_name                                             = try(each.value.vpc_ipam_pool_name, var.defaults.vpc_ipam_pool_name, null)
  vpc_ipam_pool_ram_share_allow_external_principals              = try(each.value.vpc_ipam_pool_ram_share_allow_external_principals, var.defaults.vpc_ipam_pool_ram_share_allow_external_principals, false)
  vpc_ipam_pool_ram_share_enabled                                = try(each.value.vpc_ipam_pool_ram_share_enabled, var.defaults.vpc_ipam_pool_ram_share_enabled, false)
  vpc_ipam_pool_ram_share_name                                   = try(each.value.vpc_ipam_pool_ram_share_name, var.defaults.vpc_ipam_pool_ram_share_name, null)
  vpc_ipam_pool_ram_share_principals                             = try(each.value.vpc_ipam_pool_ram_share_principals, var.defaults.vpc_ipam_pool_ram_share_principals, [])
  vpc_ipam_pool_ram_share_tags                                   = try(each.value.vpc_ipam_pool_ram_share_tags, var.defaults.vpc_ipam_pool_ram_share_tags, {})
  vpc_ipam_pool_tags                                             = try(each.value.vpc_ipam_pool_tags, var.defaults.vpc_ipam_pool_tags, {})
  vpc_ipam_scope_id                                              = try(each.value.vpc_ipam_scope_id, var.defaults.vpc_ipam_scope_id, null)
  vpc_ipam_source_pool_id                                        = try(each.value.vpc_ipam_source_pool_id, var.defaults.vpc_ipam_source_pool_id, null)
