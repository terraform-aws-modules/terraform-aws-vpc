module "wrapper" {
  ...
  create_igw                             = try(each.value.create_igw, var.defaults.create_igw, null)
  ...
  create_regional_nat_gateway            = try(each.value.create_regional_nat_gateway, var.defaults.create_regional_nat_gateway, false)
  ...
  regional_nat_gateway_availability_zone_addresses               = try(each.value.regional_nat_gateway_availability_zone_addresses, var.defaults.regional_nat_gateway_availability_zone_addresses, {})
  regional_nat_gateway_tags                                      = try(each.value.regional_nat_gateway_tags, var.defaults.regional_nat_gateway_tags, {})
