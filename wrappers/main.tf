module "wrapper" {
  ...
  nat_eip_names                                               = try(each.value.nat_eip_names, var.defaults.nat_eip_names, [])
  ...
  nat_gateway_names                                           = try(each.value.nat_gateway_names, var.defaults.nat_gateway_names, [])
