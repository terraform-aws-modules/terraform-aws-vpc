...
| <a name="input_private_subnet_tags_per_name"></a> [private\_subnet\_tags\_per\_name](#input\_private\_subnet\_tags\_per\_name) | Additional tags for the private subnets where the primary key is the Name | `map(map(string))` | `{}` | no |
...
| <a name="input_public_subnet_tags_per_name"></a> [public\_subnet\_tags\_per\_name](#input\_public\_subnet\_tags\_per\_name) | Additional tags for the public subnets where the primary key is the Name | `map(map(string))` | `{}` | no |
