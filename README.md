...
| <a name="input_nat_gateways"></a> [nat\_gateways](#input\_nat\_gateways) | Pass the amount of public NAT gateways you would like to create. Must be equal to or lower than the max amount of availability zones | `number` | `1` | no |
