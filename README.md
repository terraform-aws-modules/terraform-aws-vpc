...
| <a name="input_public_enable_default_route"></a> [public\_enable\_default\_route](#input\_public\_enable\_default\_route) | Enable default route to internet gateway for public subnets | `bool` | `true` | no |
