...
| [aws_network_acl.public_eks_blue](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/network_acl) | resource |
...
| <a name="input_private_eks_subnet_tags_blue"></a> [private\_eks\_subnet\_tags\_blue](#input\_private\_eks\_subnet\_tags\_blue) | Additional tags for the private eks subnets | `map(string)` | `{}` | no |
| <a name="input_private_eks_subnet_tags_green"></a> [private\_eks\_subnet\_tags\_green](#input\_private\_eks\_subnet\_tags\_green) | Additional tags for the private eks subnets | `map(string)` | `{}` | no |
| <a name="input_private_eks_subnets_blue"></a> [private\_eks\_subnets\_blue](#input\_private\_eks\_subnets\_blue) | A list of private eks subnets inside the VPC | `list(string)` | `[]` | no |
| <a name="input_private_eks_subnets_green"></a> [private\_eks\_subnets\_green](#input\_private\_eks\_subnets\_green) | A list of private eks subnets inside the VPC | `list(string)` | `[]` | no |
...
| <a name="input_public_eks_subnet_tags_blue"></a> [public\_eks\_subnet\_tags\_blue](#input\_public\_eks\_subnet\_tags\_blue) | Additional tags for the private eks subnets | `map(string)` | `{}` | no |
| <a name="input_public_eks_subnet_tags_green"></a> [public\_eks\_subnet\_tags\_green](#input\_public\_eks\_subnet\_tags\_green) | Additional tags for the private eks subnets | `map(string)` | `{}` | no |
| <a name="input_public_eks_subnets_blue"></a> [public\_eks\_subnets\_blue](#input\_public\_eks\_subnets\_blue) | A list of public subnets inside the VPC | `list(string)` | `[]` | no |
| <a name="input_public_eks_subnets_green"></a> [public\_eks\_subnets\_green](#input\_public\_eks\_subnets\_green) | A list of public subnets inside the VPC | `list(string)` | `[]` | no |
...
| <a name="output_private_eks_subnets_blue"></a> [private\_eks\_subnets\_blue](#output\_private\_eks\_subnets\_blue) | List of IDs of eks private subnets |
| <a name="output_private_eks_subnets_cidr_blocks_blue"></a> [private\_eks\_subnets\_cidr\_blocks\_blue](#output\_private\_eks\_subnets\_cidr\_blocks\_blue) | List of cidr\_blocks of eks private subnets |
| <a name="output_private_eks_subnets_cidr_blocks_green"></a> [private\_eks\_subnets\_cidr\_blocks\_green](#output\_private\_eks\_subnets\_cidr\_blocks\_green) | List of cidr\_blocks of eks private subnets |
| <a name="output_private_eks_subnets_green"></a> [private\_eks\_subnets\_green](#output\_private\_eks\_subnets\_green) | List of IDs of eks private subnets |
...
| <a name="output_public_eks_subnets_blue"></a> [public\_eks\_subnets\_blue](#output\_public\_eks\_subnets\_blue) | List of IDs of eks public subnets |
| <a name="output_public_eks_subnets_cidr_blocks_blue"></a> [public\_eks\_subnets\_cidr\_blocks\_blue](#output\_public\_eks\_subnets\_cidr\_blocks\_blue) | List of cidr\_blocks of eks public subnets |
| <a name="output_public_eks_subnets_cidr_blocks_green"></a> [public\_eks\_subnets\_cidr\_blocks\_green](#output\_public\_eks\_subnets\_cidr\_blocks\_green) | List of cidr\_blocks of eks public subnets |
| <a name="output_public_eks_subnets_green"></a> [public\_eks\_subnets\_green](#output\_public\_eks\_subnets\_green) | List of IDs of eks public subnets |
