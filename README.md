...
| <a name="input_intra_subnet_create_multiple_route_tables"></a> [intra\_subnet\_create\_multiple\_route\_tables](#input\_intra\_subnet\_create\_multiple\_route\_tables) | Indicates whether to create a separate route table for each intra subnet. Default: `false` | `bool` | `false` | no |
...
| <a name="input_public_subnet_create_multiple_route_tables"></a> [public\_subnet\_create\_multiple\_route\_tables](#input\_public\_subnet\_create\_multiple\_route\_tables) | Indicates whether to create a separate route table for each public subnet. Default: `false` | `bool` | `false` | no |
