...
| <a name="input_nat_eip_names"></a> [nat\_eip\_names](#input\_nat\_eip\_names) | Explicit values to use in the Name tag on NAT EIPs. If empty, Name tags are generated | `list(string)` | `[]` | no |
...
| <a name="input_nat_gateway_names"></a> [nat\_gateway\_names](#input\_nat\_gateway\_names) | Explicit values to use in the Name tag on NAT gateways. If empty, Name tags are generated | `list(string)` | `[]` | no |
