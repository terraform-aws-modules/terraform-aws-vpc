...
| <a name="input_public_route_table_routes_extra"></a> [default\_route\_table\_routes](#input\_default\_route\_table\_routes) | Configuration block of additional routes for public subnets route tables. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/default_route_table#route | `list(map(string))` | `[]` | no |
