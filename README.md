...
| <a name="input_database_network_acl_excluded_subnets"></a> [database\_network\_acl\_excluded\_subnets](#input\_database\_network\_acl\_excluded\_subnets) | Exclude these database subnets from network ACL management (useful for testing availability zone failure) | `list(string)` | `[]` | no |
...
| <a name="input_elasticache_network_acl_excluded_subnets"></a> [elasticache\_network\_acl\_excluded\_subnets](#input\_elasticache\_network\_acl\_excluded\_subnets) | Exclude these elasticache subnets from network ACL management (useful for testing availability zone failure) | `list(string)` | `[]` | no |
...
| <a name="input_intra_network_acl_excluded_subnets"></a> [intra\_network\_acl\_excluded\_subnets](#input\_intra\_network\_acl\_excluded\_subnets) | Exclude these intra subnets from network ACL management (useful for testing availability zone failure) | `list(string)` | `[]` | no |
...
| <a name="input_outpost_network_acl_excluded_subnets"></a> [outpost\_network\_acl\_excluded\_subnets](#input\_outpost\_network\_acl\_excluded\_subnets) | Exclude these outpost subnets from network ACL management (useful for testing availability zone failure) | `list(string)` | `[]` | no |
...
| <a name="input_private_network_acl_excluded_subnets"></a> [private\_network\_acl\_excluded\_subnets](#input\_private\_network\_acl\_excluded\_subnets) | Exclude these private subnets from network ACL management (useful for testing availability zone failure) | `list(string)` | `[]` | no |
...
| <a name="input_public_network_acl_excluded_subnets"></a> [public\_network\_acl\_excluded\_subnets](#input\_public\_network\_acl\_excluded\_subnets) | Exclude these public subnets from network ACL management (useful for testing availability zone failure) | `list(string)` | `[]` | no |
...
| <a name="input_redshift_network_acl_excluded_subnets"></a> [redshift\_network\_acl\_excluded\_subnets](#input\_redshift\_network\_acl\_excluded\_subnets) | Exclude these redshift subnets from network ACL management (useful for testing availability zone failure) | `list(string)` | `[]` | no |
