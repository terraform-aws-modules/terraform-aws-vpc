...
| [aws_route.database_internet_gateway_ipv6](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route) | resource |
...
| <a name="input_create_database_egress_only_internet_gateway_route"></a> [create\_database\_egress\_only\_internet\_gateway\_route](#input\_create\_database\_egress\_only\_internet\_gateway\_route) | Controls if an egress-only internet gateway route for public database access should be created | `bool` | `false` | no |
