...
* [Elasticsearch Subnet](https://www.terraform.io/docs/providers/aws/r/elasticsearch_domain.html) - A set of subnets within a VPC where a VPC based elasticserach domain can be launched with the elasticsearch domain terraform provider.
