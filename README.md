...
| <a name="input_database_route_tables_routes"></a> [database\_route\_tables\_routes](#input\_database\_route\_tables\_routes) | Configuration block of routes. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table#route-argument-reference | `list(map(string))` | `[]` | no |
...
| <a name="input_elasticache_route_tables_routes"></a> [elasticache\_route\_tables\_routes](#input\_elasticache\_route\_tables\_routes) | Configuration block of routes. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table#route-argument-reference | `list(map(string))` | `[]` | no |
...
| <a name="input_intra_route_tables_routes"></a> [intra\_route\_tables\_routes](#input\_intra\_route\_tables\_routes) | Configuration block of routes. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table#route-argument-reference | `list(map(string))` | `[]` | no |
...
| <a name="input_private_route_tables_routes"></a> [private\_route\_tables\_routes](#input\_private\_route\_tables\_routes) | Configuration block of routes. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table#route-argument-reference | `list(map(string))` | `[]` | no |
...
| <a name="input_public_route_tables_routes"></a> [public\_route\_tables\_routes](#input\_public\_route\_tables\_routes) | Configuration block of routes. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table#route-argument-reference | `list(map(string))` | `[]` | no |
...
| <a name="input_redshift_route_tables_routes"></a> [redshift\_route\_tables\_routes](#input\_redshift\_route\_tables\_routes) | Configuration block of routes. See https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table#route-argument-reference | `list(map(string))` | `[]` | no |
