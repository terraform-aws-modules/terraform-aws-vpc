...
| <a name="output_public_subnet_availability_zones"></a> [public_subnet_availability_zones](#output_public_subnet_availability_zones) | List of availability zones for public subnets |
