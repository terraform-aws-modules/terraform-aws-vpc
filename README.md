...
| <a name="input_create_public_route_association"></a> [create\_public\_route\_association](#input\_create\_public\_route\_association) | Option to associate public route tables | `bool` | `true` | no |
